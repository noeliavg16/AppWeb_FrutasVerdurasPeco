...
/**
 * Me creo la clase Empresa donde relaciono la tabla a la que hace referencia esta clase en la BBDD y 
...
@Data
@Entity
@Table(name="EMPRESA")//es el nombre de la tabla a la que hace referencia en la BBDD
public class Empresa {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name="ID_EMPRESA")// es el nombre de la columna a la que hace referencia en la BBDD
